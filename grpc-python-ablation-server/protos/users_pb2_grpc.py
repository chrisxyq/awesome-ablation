...
class UsersStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Test = channel.unary_stream(
                '/Users/Test',
                request_serializer=users__pb2.TestRequest.SerializeToString,
                response_deserializer=users__pb2.TestResult.FromString,
                )
...
def add_UsersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Test': grpc.unary_stream_rpc_method_handler(
                    servicer.Test,
                    request_deserializer=users__pb2.TestRequest.FromString,
                    response_serializer=users__pb2.TestResult.SerializeToString,
            ),
    }
...
class Users(object):
    ...
    def Test(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/Users/Test',
            users__pb2.TestRequest.SerializeToString,
            users__pb2.TestResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
